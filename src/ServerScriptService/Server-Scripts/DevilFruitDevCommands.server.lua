...
adminCommandFlowLog("AdminCommandBootstrap server script started")
...
adminCommandFlowLog("AdminCommandBootstrap dependencies loaded")
...
require(ServerScriptService.Modules.AdminCommands.TextChatCommandRegistrar).Setup({
	TextChatService = TextChatService,
	Players = Players,
	NormalizeText = normalizeText,
	HandleChatCommand = handleChatCommand,
	Log = adminCommandFlowLog,
	Warn = adminCommandFlowWarn,
})
