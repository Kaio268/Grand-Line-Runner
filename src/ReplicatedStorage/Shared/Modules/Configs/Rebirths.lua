do
	return require(
		game:GetService("ReplicatedStorage"):WaitForChild("Modules"):WaitForChild("Configs"):WaitForChild("Rebirths")
	)
end
...
local Rebirths = {
	[1] = {
		...
		Getting = {
			...
			["Potions.x2MoneyTime"] = { Amount = 150, Icon = "rbxassetid://123727379614328" },
	...
	[2] = {
		...
		Getting = {
			...
			["Potions.x2MoneyTime"] = { Amount = 300, Icon = "rbxassetid://123727379614328" },
	...
	[3] = {
		...
		Getting = {
			...
			["Potions.x2MoneyTime"] = { Amount = 450, Icon = "rbxassetid://123727379614328" },
	...
	[5] = {
		...
		Getting = {
			...
			["Potions.x2MoneyTime"] = { Amount = 750, Icon = "rbxassetid://123727379614328" },
	...
	[6] = {
		...
		Getting = {
			...
			["Potions.x2MoneyTime"] = { Amount = 900, Icon = "rbxassetid://123727379614328" },
	...
	[8] = {
		...
		Getting = {
			...
			["Potions.x2MoneyTime"] = { Amount = 1500, Icon = "rbxassetid://123727379614328" },
