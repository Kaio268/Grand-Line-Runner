...
local DevilFruits = {
	...
	FruitsByKey = {
		Inferno = {
			...
			Abilities = {
				FlameDash = {
					...
					DistanceSpeedBonusFactor = 3,
					MaxDistanceSpeedBonus = 240,
					BaseDashSpeed = 500,
					DashSpeedMultiplier = 1.15,
					DashSpeedBonusFactor = 0.75,
					MaxDashSpeedBonus = 60,
					EndDashSpeedMultiplier = 1.1,
					RequiredSpeedMultiplier = 0,
					MaxDashSpeed = 500,
		...
		Burrow = {
			...
			Abilities = {
				Burrow = {
					...
					StartupInvincibilityMaxSeconds = 0.75,
					StartupInvincibilityStartOffsetSeconds = 1,
					DebugStartupDamageTrace = false,
					...
					Animation = {
						Start = {
							...
							MovementCueFallbackTime = 0.66,
							MinManualResolveDelay = 0.66,
							ConcealDelay = 0,
							BurrowStartSinkDelay = 0,
							RequireGroundedStart = true,
							BurrowGroundContactTolerance = 1.75,
							HighSpeedServerConfirmedStartSpeed = 96,
							StabilizeCameraDuringSink = true,
							CameraStabilizationMode = "SmoothOffset",
							CameraStabilizationSmoothTime = 0.06,
							CameraStabilizationRestoreTime = 0.11,
							VisualSinkDepth = 3.2,
							VisualSinkDuration = 0.34,
							VisualSinkEasingStyle = "Sine",
						...
						Resolve = {
							...
							AnimationBackOffset = 0.85,
							BackJerkDistance = 3,
							BackJerkDuration = 0.08,
						},
					},
					Vfx = {
					...
					RequestPayloadSchema = {
						...
						Fields = {
							...
							CurrentSurfacePosition = "Vector3",
							SessionId = "String",
						},
					},
				},
		...
		Spirit = {
			...
			Abilities = {
				GhostProjection = {
					...
					PickupThrottle = 0.18,
					PickupRangeGraceDuration = 0.45,
					PickupRangeGraceDistance = 10,
					BodyWalkSpeed = 0,
					BodyJumpPower = 0,
		...
		Phoenix = {
			Id = "PhoenixFruitModel",
			FruitKey = "Phoenix",
			DisplayName = "Phoenix Fruit",
			AssetFolder = "Phoenix",
			LegacyAssetFolders = { "Tori" },
			AbilityModule = "Phoenix",
			Rarity = "Mythic",
			ToolGripBias = HELD_FRUIT_GRIP_BIAS,
			Aliases = {
				"ToriToriNoMiModelPhoenix",
				"tori",
				"tori tori",
				"tori tori no mi",
				"phoenix",
			...
			Abilities = {
				PhoenixFlight = {
					...
					MaxRiseHeight = 132,
					FlightSpeed = 80,
					FlightSpeedScaleReference = 17,
					FlightSpeedScaleStrength = 0.1,
					VerticalSpeed = 160,
					MaxDescendSpeed = 72,
					HorizontalResponsiveness = 18,
					...
					Animation = {
						StartAnimationKey = "Phoenix.PhoenixFlightStart",
						LoopAnimationKey = "Phoenix.PhoenixFlightLoop",
						IdleAnimationKey = "Phoenix.PhoenixFlightIdle",
						EndAnimationKey = "Phoenix.PhoenixFlightEnd",
						FadeTime = 0.08,
						StopFadeTime = 0.12,
						StartPlaybackSpeed = 1,
						LoopPlaybackSpeed = 1,
						IdlePlaybackSpeed = 1,
						EndPlaybackSpeed = 2.25,
					},
				},
				PhoenixFlameShield = {
					KeyCode = Enum.KeyCode.C,
					...
					SpeedRadiusScaling = {
						...
						SpeedForMaxScale = 300,
						MinScale = 1,
						ScaleBonusPerSpeedRange = 0.45,
						UsePlanarVelocity = false,
						UseWalkSpeed = false,
					},
					Duration = 5,
					AnimationLockDuration = 0.35,
					Animation = {
						AnimationKey = "Phoenix.PhoenixFlameShield",
						FadeTime = 0.06,
						StopFadeTime = 0.1,
						PlaybackSpeed = 3,
						Looped = false,
