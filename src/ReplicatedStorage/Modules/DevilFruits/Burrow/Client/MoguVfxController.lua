...
local MoguAssetCatalog = require(
	Modules:WaitForChild("DevilFruits"):WaitForChild("Burrow"):WaitForChild("Shared"):WaitForChild("MoguAssetCatalog")
)
local VfxCommon = require(
	Modules:WaitForChild("DevilFruits"):WaitForChild("Inferno"):WaitForChild("Shared"):WaitForChild("Vfx"):WaitForChild("VfxCommon")
)
