...
local REGISTRY_KEY_BY_MOVE = {
	FlameDash = "Inferno.FlameDash",
	FireBurst = "Inferno.FlameBurstR6",
}
...
local function getAnimationSearchRoots()
	...
	local assetsMeraFolder = assetsAnimationsFolder
		and (assetsAnimationsFolder:FindFirstChild("Inferno") or assetsAnimationsFolder:FindFirstChild("Mera"))
	local replicatedAnimationsFolder = ReplicatedStorage:FindFirstChild("Animations")
	local replicatedMeraFolder = replicatedAnimationsFolder
		and (replicatedAnimationsFolder:FindFirstChild("Inferno") or replicatedAnimationsFolder:FindFirstChild("Mera"))
