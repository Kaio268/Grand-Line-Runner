...
for _, fruitConfig in ipairs(DevilFruitConfig.GetAllFruits()) do
	local fruitEntry = {
		...
		ClientModuleName = fruitConfig.ClientModule or fruitConfig.FruitKey,
		ServerModuleName = fruitConfig.ServerModule or fruitConfig.AbilityModule or fruitConfig.FruitKey,
		Config = fruitConfig,
		Abilities = {},
		AbilityList = {},
		AbilityByKeyCode = {},
