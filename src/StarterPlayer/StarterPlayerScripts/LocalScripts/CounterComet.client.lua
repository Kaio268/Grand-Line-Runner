...
local counter = counters:WaitForChild("Comet")
...
local normalG0 = Color3.fromRGB(190, 164, 221)
local normalG1 = Color3.fromRGB(230, 243, 255)
local normalStroke = Color3.fromRGB(51, 53, 57)
