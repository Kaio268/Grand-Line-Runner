...
-- Keep the frame/host un-clipped so the gold INDEX pill + close button can overlap
-- the top edge (the modal adapter re-clips the frame on its own styling passes).
